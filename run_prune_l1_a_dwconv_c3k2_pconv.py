#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""L1 pruning entry for A-DWConv-C3k2_PConv aligned to the Taylor setup.

This wrapper keeps the same pruning scope and runtime settings as the current
Taylor runner, while swapping only the importance score to L1.

Usage:
    python run_prune_l1_a_dwconv_c3k2_pconv.py
"""
...
OUTPUT = ROOT / "prune_outputs_l1_compare_c3k2"
