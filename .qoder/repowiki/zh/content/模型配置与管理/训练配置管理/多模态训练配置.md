...
- [rtdetr-r18-mm-mid.yaml](file://ultralytics/cfg/models/rtmm/r18/rtdetr-r18-mm-mid.yaml)
...
- [multimodal_augment.py:1020-1127](file://ultralytics/data/multimodal_augment.py#L1020-L1127)
...
Trainer->>Data : 构建数据集与增强链
Data-->>Trainer : 训练批次(含RGB+X)
Trainer->>Model : 前向传播
Model->>Router : 按第5字段路由(RGB/X/Dual)
Router-->>Model : 融合/分路特征
Model-->>Trainer : 损失与梯度
Trainer-->>User : 训练日志/权重
User->>Infer : 调用推理引擎
Infer->>Data : 配对解析与预处理
...
- [rtdetr-r18-mm-mid.yaml:12-67](file://ultralytics/cfg/models/rtmm/r18/rtdetr-r18-mm-mid.yaml#L12-L67)
...
- [rtdetr-r18-mm-mid.yaml:1-67](file://ultralytics/cfg/models/rtmm/r18/rtdetr-r18-mm-mid.yaml#L1-L67)
...
**图表来源**
- [yolo11n-mm-early.yaml:19-59](file://ultralytics/cfg/models/mm/yolo11n-mm-early.yaml#L19-L59)
- [rtdetr-r18-mm-mid.yaml:33-39](file://ultralytics/cfg/models/rtmm/r18/rtdetr-r18-mm-mid.yaml#L33-L39)
...
- [multimodal_augment.py:1020-1127](file://ultralytics/data/multimodal_augment.py#L1020-L1127)
- [predictor.py:1-98](file://ultralytics/engine/multimodal/predictor.py#L1-L98)
...
## 结论
通过配置驱动与Router机制，本项目实现了RGB+X多模态的灵活融合与高效训练。合理选择融合策略、配置异步几何扰动与模态丢弃、结合IR/深度专属增强，可在复杂场景下显著提升鲁棒性与泛化能力。建议在实验中以args.yaml为入口，逐步调整增强强度与融合位置，结合可视化与指标进行对比分析。
