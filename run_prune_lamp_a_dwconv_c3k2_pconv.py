#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""LAMP pruning entry for A-DWConv-C3k2_PConv aligned to the Taylor setup."""
...
OUTPUT = ROOT / "prune_outputs_lamp_compare_c3k2"
...
def main() -> int:
    ...
    import prune_lamp_taylorlike

    sys.argv = [
        "prune_lamp_taylorlike.py",
        "--weights", str(WEIGHTS),
        "--output", str(OUTPUT),
        "--data", str(DATA),
        "--device", DEVICE,
    ...
    return prune_lamp_taylorlike.main()
