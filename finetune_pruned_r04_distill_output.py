...
DEFAULT_MODEL = Path(r"D:\BaiduNetdiskDownload\MutilModel_3398475911\runs_finetune\M3F-0.4-dep+ty-150\weights\best.pt")
DEFAULT_DATA = Path(r"D:\BaiduNetdiskDownload\M3FD\M3FD_split\data.yaml")
DEFAULT_DISTILL = Path(r"D:\BaiduNetdiskDownload\MutilModel_3398475911\distill_r04_output.yaml")
DEFAULT_PROJECT = Path(r"D:\JiQI\MM-experiment\DistillRT")
DEFAULT_NAME = "tylor-dep-0.4-outputdistill-cmxfusion2-teacher"
DEFAULT_EXPECTED_PARAMS = 8422322
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fine-tune r0.4 pruned RTDETRMM with output distillation.")
