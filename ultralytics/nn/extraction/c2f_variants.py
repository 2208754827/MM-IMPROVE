...
class CSP_MutilScaleEdgeInformationSelect(C2fVariantBase):
    """CSP wrapper for MutilScaleEdgeInformationSelect from RTDETR-20260203."""

    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self._build_blocks(n, lambda: MutilScaleEdgeInformationSelect(self.c, [3, 6, 9, 12]))


class CSP_MutilScaleEdgeInformationEnhance(C2fVariantBase):
    """CSP wrapper for MutilScaleEdgeInformationEnhance from RTDETR-20260203."""

    def __init__(self, c1, c2, n=1, shortcut=False, g=1, e=0.5):
        super().__init__(c1, c2, n, shortcut, g, e)
        self._build_blocks(n, lambda: MutilScaleEdgeInformationEnhance(self.c, [3, 6, 9, 12]))


class CSP_FreqSpatial(C2fVariantBase):
    """CSP wrapper for FreqSpatial from RTDETR-20260203."""
